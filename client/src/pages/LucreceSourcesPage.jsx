...
const sourceCards = [
  {
    ...
    links: [
      ...
      { label: "Open Full Image", href: "https://upload.wikimedia.org/wikipedia/commons/3/34/Giovanni_Battista_Tiepolo_090.jpg" },
    ],
  },
  {
    ...
    links: [
      ...
      { label: "Open Full Image", href: "https://upload.wikimedia.org/wikipedia/commons/d/d6/Titus-Livius-Austrian-Parliament-Building.jpg" },
    ],
  },
  {
    ...
    image: {
      ...
      href: "https://upload.wikimedia.org/wikipedia/commons/5/57/Chaucer_manuscrit_portrait_%28d%C3%A9tail%29.jpeg",
    ...
    links: [
      ...
      { label: "Open Image", href: "https://upload.wikimedia.org/wikipedia/commons/5/57/Chaucer_manuscrit_portrait_%28d%C3%A9tail%29.jpeg" },
    ],
  },
  {
    ...
    links: [
      { label: "Open Page Scan", href: "https://archive.org/download/bim_early-english-books-1475-1640_the-palace-of-pleasure-_painter-william_1575/page/n1.jpg" },
    ],
  },
];
            ...
            <div style={{ display: "flex", gap: 18, flexWrap: "wrap", alignItems: "flex-start" }}>
              {item.image && (
                <a
                  ...
                  style={{ display: "block", flex: "0 0 220px", maxWidth: "100%", textDecoration: "none" }}
                >
                  <img
                    src={item.image.src}
                    alt={item.image.alt}
